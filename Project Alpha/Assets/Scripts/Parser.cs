                ...
                try
                {
                    switch (int.Parse(tempArray[0]))
                    {
                        ...
                        case 5:
                            ...
                            {
                                case 0:
                                    GamePlayManager.Instance.CreateNote(NoteType.Touch, touchNotePrefab, slideNotePrefab);
                                    break;
                                case 1:
                                    GamePlayManager.Instance.CreateNote(NoteType.Slide, touchNotePrefab, slideNotePrefab);
                                    break;
                            }
